...
<template>
  <b-card v-bind:title="playerName" align="center" tag="article" class="mb-2">
    ...
    <b-row>
      <b-col>
        <b-row>
          <b-col>
            <i class="far fa-futbol fa-2x vertical-center"></i>
          </b-col>
          <b-col>
            <b-row>
              <b-col class="text-right">Season</b-col>
            </b-row>
            <b-row>
              <b-col class="text-right">{{playerSeasonGoals}}</b-col>
            </b-row>
          </b-col>
        </b-row>
      </b-col>
      <b-col>
        <b-row>
          ...
          <b-col>
            <b-row>
              <b-col class="text-right">Lifetime</b-col>
            </b-row>
            <b-row>
              <b-col class="text-right">{{playerTotalGoals}}</b-col>
            </b-row>
          </b-col>
        </b-row>
      </b-col>
